      ...
      <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
          ...
          <div className="grid grid-cols-2 gap-4">
               ...
               <div className="bg-[#1a1a1a] p-3 rounded-xl border border-[#333]">
                  <label className="block text-[10px] font-bold text-slate-500 mb-2 uppercase">Order Book Bid (Support)</label>
                  <textarea className="w-full bg-transparent border-none text-white font-mono text-xs h-24 outline-none resize-none placeholder:text-slate-700" placeholder="Paste Bid Volume..." value={formData.bandarmology.orderBookBid} onChange={(e) => handleChange('bandarmology', 'orderBookBid', e.target.value)} />
              </div>
              <div className="bg-[#1a1a1a] p-3 rounded-xl border border-[#333]">
                  <label className="block text-[10px] font-bold text-slate-500 mb-2 uppercase">Order Book Ask (Resistance)</label>
                  <textarea className="w-full bg-transparent border-none text-white font-mono text-xs h-24 outline-none resize-none placeholder:text-slate-700" placeholder="Paste Ask Volume..." value={formData.bandarmology.orderBookAsk} onChange={(e) => handleChange('bandarmology', 'orderBookAsk', e.target.value)} />
              </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-[#1a1a1a] p-3 rounded-xl border border-[#333]">
                  <label className="block text-[10px] font-bold text-emerald-500 mb-2 uppercase flex items-center gap-2">
                      <Zap size={12}/> BUY (HAKA - Aggressive Buy)
                  </label>
                  <textarea 
                    className="w-full bg-transparent border-none text-white font-mono text-xs h-16 outline-none resize-none placeholder:text-slate-700" 
              ...
              <div className="bg-[#1a1a1a] p-3 rounded-xl border border-[#333]">
                  <label className="block text-[10px] font-bold text-rose-500 mb-2 uppercase flex items-center gap-2">
